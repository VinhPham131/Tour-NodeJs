            ...
            <div className="container-fluid relative">
                <div className="grid grid-cols-1">
                    <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                        ...
                        <div className="text-center">
                            <p className="mb-0 text-slate-400">© {new Date().getFullYear()} Tripster Booking Tours <i className="mdi mdi-heart text-red-600"></i> by <Link to="https://www.facebook.com/profile.php?id=100006106118260&locale=vi_VN" target="_blank" className="text-reset">VinhPham</Link>.</p>
                        </div>
                    </div>
                </div>
            </div>

            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
                ...
                <div className="md:col-span-7">
                    <div className="lg:ms-8">
                        <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">World Best Travel <br/> Agency: Tripster</h3>

                        <p className="text-slate-400 max-w-xl mb-6">
                            Book your tours effortlessly with Tripster Travel. Discover and reserve exciting tours and activities at your destination with just a few taps. Enjoy a seamless booking experience, secure payment options, and instant confirmations. Explore the world with confidence and convenience using Tripster
                        </p>

                        <Link to="/contact" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md">Read More <i className="mdi mdi-chevron-right align-middle ms-0.5"></i></Link>
                    </div>
                </div>
